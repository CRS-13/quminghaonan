...
if __name__ == "__main__":
    ...
    parser.add_argument('--new_test_r19_Score', default = '/home/zjl_laoshi/xiaoke/UAV-SAR/infogcn/result/A/_1_aug/epoch1_test_score.pkl')
    parser.add_argument('--new_test_r20_Score', default = '/home/zjl_laoshi/xiaoke/UAV-SAR/infogcn/result/A/_2_aug/epoch1_test_score.pkl')
    parser.add_argument('--new_test_r21_Score', default = '/home/zjl_laoshi/xiaoke/UAV-SAR/infogcn/result/A/_6_aug/epoch1_test_score.pkl')
    parser.add_argument('--new_test_r22_Score', default = '/home/zjl_laoshi/xiaoke/UAV-SAR/infogcn/result/A/32frame_1/epoch1_test_score.pkl')  ##**
    parser.add_argument('--new_test_r23_Score', default = '/home/zjl_laoshi/xiaoke/UAV-SAR/infogcn/result/A/128frame_1/epoch1_test_score.pkl')  ##**
    parser.add_argument('--new_test_r24_Score', default = '/home/zjl_laoshi/xiaoke/UAV-SAR/infogcn/result/A/focalloss_1/epoch1_test_score.pkl') 
    parser.add_argument('--new_test_r25_Score', default = '/home/zjl_laoshi/xiaoke/UAV-SAR/mixformer/results/A/_1/epoch1_test_score.pkl') 
    parser.add_argument('--new_test_r26_Score', default = '/home/zjl_laoshi/xiaoke/UAV-SAR/mixformer/results/A/_2/epoch1_test_score.pkl')
    parser.add_argument('--new_test_r27_Score', default = '/home/zjl_laoshi/xiaoke/UAV-SAR/mixformer/results/A/_6/epoch1_test_score.pkl') 
    ...
    accuracies = [0.7, 0.7, 0.2, 0.2, 0.2, 0.2, 0.7, 0.7, 0.2, 0.2, 
                  0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.2, 0.2, 0.3, 0.3,
